    ...
    <body>
        ...
        <div class="Mbk_Accessories_1">
            <div id="Mbk_Accessories_nav">
                <a href="../Mbk_Main.php">Home</a> > <a href="../Mbk_Accessories.php">Accessories</a> > Bastille Sunglasses in White Gold
            </div>
            ...
            <div class="container">
                <div id="Mbk_Accessories_image">
                    <img src="../../Image/Glasses/Glasses Angle/Bastille Sunglasses in White Gold/5-17_Product-12_1024x1024@2x.jpg" class="image normal-zoom" id="main">
                </div> 
            </div>
               <div class="box1">
                    <div id="Mbk_Accessories_image1">
                        <img src="../../Image/Glasses/Glasses Angle/Bastille Sunglasses in White Gold/5-17_Product-12_1024x1024@2x.jpg" id="accessories_img" onclick="change(this.src)">
                    </div>
                    <div id="Mbk_Accessories_image2">
                        <img src="../../Image/Glasses/Glasses Angle/Bastille Sunglasses in White Gold/5-17_Product-13_1024x1024@2x.jpg" id="accessories_img" onclick="change(this.src)">
                    </div>
                    <div id="Mbk_Accessories_image3">
                        <img src="../../Image/Glasses/Glasses Angle/Bastille Sunglasses in White Gold/6-2_Womens_SunglassesOnFigure-4_1024x1024@2x.jpg" id="accessories_img" onclick="change(this.src)">
                    </div>
                    <div id="Mbk_Accessories_image4">
                        <img src="../../Image/Glasses/Glasses Angle/Bastille Sunglasses in White Gold/Ahlem_Bastille-Silver-2_1024x1024@2x.jpg" id="accessories_img" onclick="change(this.src)">
                    </div>
               </div>   
            ...
            <div id="Mbk_Accessories_image_desc">
                ...
                <div id="Mbk_Accessories_image_desc_title1">
                    Bastille Sunglasses in White Gold
                </div>
