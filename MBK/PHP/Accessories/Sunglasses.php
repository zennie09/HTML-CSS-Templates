    ...
    <body>
        ...
        <div class="Mbk_Accessories_1">
            <div id="Mbk_Accessories_nav">
                <a href="../Mbk_Main.php">Home</a> > <a href="../Mbk_Accessories.php">Accessories</a> > Madeline Sunglasses in White Gold
            </div>
            ...
            <div class="container">
                <div id="Mbk_Accessories_image">
                    <img src="../../Image/Glasses/Glasses Angle/Madeline Sunglasses in White Gold/5-17_Product-1_1024x1024@2x.jpg" class="image normal-zoom" id="main">
                </div> 
            </div>
               <div class="box1">
                    <div id="Mbk_Accessories_image1">
                        <img src="../../Image/Glasses/Glasses Angle/Madeline Sunglasses in White Gold/5-17_Product-1_1024x1024@2x.jpg" id="accessories_img" onclick="change(this.src)">
                    </div>
                    <div id="Mbk_Accessories_image2">
                        <img src="../../Image/Glasses/Glasses Angle/Madeline Sunglasses in White Gold/5-17_Product-3_1024x1024@2x.jpg" id="accessories_img" onclick="change(this.src)">
                    </div>
                    <div id="Mbk_Accessories_image3">
                        <img src="../../Image/Glasses/Glasses Angle/Madeline Sunglasses in White Gold/5-17_Product-2_1024x1024@2x.jpg" id="accessories_img" onclick="change(this.src)">
                    </div>
                    <div id="Mbk_Accessories_image4">
                        <img src="../../Image/Glasses/Glasses Angle/Madeline Sunglasses in White Gold/5-17_Product-4_1024x1024@2x.jpg" id="accessories_img" onclick="change(this.src)">
                    </div>
               </div>   
            ...
            <div id="Mbk_Accessories_image_desc">
                ...
                <div id="Mbk_Accessories_image_desc_title1">
                    Madeline Sunglasses in White Gold
                </div>
                ...
                <div id="Mbk_Accessories_image_desc_btns">
                   <button class="Mbk_Accessories_image_desc_add_to_car_btn" onclick="location.href = '../Mbk_Cart.php';">ADD TO CART</button>
