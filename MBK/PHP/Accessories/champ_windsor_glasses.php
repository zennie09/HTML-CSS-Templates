    ...
    <body>
        ...
        <div class="Mbk_Accessories_1">
            <div id="Mbk_Accessories_nav">
                <a href="../Mbk_Main.php">Home</a> > <a href="../Mbk_Accessories.php">Accessories</a> > Madeline Sunglasses in Champagne Windsor
            </div>
            <div id="Mbk_Accessories_Title">
                <label id="Mbk_Title">Accessories</label>
            </div>
            <div class="container">
                <div id="Mbk_Accessories_image">
                    <img src="../../Image/Glasses/Glasses Angle/Madeline Sunglasses in Champagne Windsor/5-17_Product-5_1024x1024@2x.jpg" class="image normal-zoom" id="main">
                </div> 
            </div>
               <div class="box1">
                    <div id="Mbk_Accessories_image1">
                        <img src="../../Image/Glasses/Glasses Angle/Madeline Sunglasses in Champagne Windsor/5-17_Product-5_1024x1024@2x.jpg" id="accessories_img" onclick="change(this.src)">
                    </div>
                    <div id="Mbk_Accessories_image2">
                        <img src="../../Image/Glasses/Glasses Angle/Madeline Sunglasses in Champagne Windsor/5-17_Product-7_1024x1024@2x.jpg" id="accessories_img" onclick="change(this.src)">
                    </div>
                    <div id="Mbk_Accessories_image3">
                        <img src="../../Image/Glasses/Glasses Angle/Madeline Sunglasses in Champagne Windsor/5-17_Product-6_1024x1024@2x.jpg" id="accessories_img" onclick="change(this.src)">
                    </div>
                    <div id="Mbk_Accessories_image4">
                        <img src="../../Image/Glasses/Glasses Angle/Madeline Sunglasses in Champagne Windsor/5-17_Product-8_1024x1024@2x.jpg" id="accessories_img" onclick="change(this.src)">
                    </div>
                    <!--<div id="Mbk_Accessories_image1">
                        <img src="../../Image/Glasses/Glasses Angle/Madeline Sunglasses in Champagne Windsor/6-2_Womens_SunglassesOnFigure-5_1024x1024@2x.jpg" id="accessories_img" onclick="change(this.src)">
                    </div>-->
               </div>   
            ...
            <div id="Mbk_Accessories_image_desc">
                ...
                <div id="Mbk_Accessories_image_desc_title1">
                    Madeline Sunglasses in Champagne Windsor
                </div>
            ...
            <div id="Mbk_Accessories_image_desc_info">
                ...
                <div id="desc_info_links_desc">
                    ...
                    <div id="desc_info_links_desc_1">
                        Madeline Sunglasses in Champagne Windsor by Ahlem. 
                        Classic and sleek sunglasses feature a brushed gold frame, 
                        thin tortoise shell detailing, flat brown lenses, ceramic nose pads, 
                        and flex hinges. 
                    </div>

                    <ul id="desc_info_links_ul">
                        <li>Palladium, plated with Gold 0.5 mocron</li>
                        <li>100% UVA/UVB protection</li>
                        <li>Christian Dalloz Cridal Flat Lenses with an inside anti-reflection coating</li>
                        <li>Signature vintage acetate temple tip</li>
                        <li>Handmade in France</li>
                        <li>Comes with cloth and case</li>
                        <li>Size: 53-20-145</li>
                        <li>Unisex</li>
                    </ul>  
                </div>
                ...
                <div class="box1">
                    <div id="Mbk_Accessories_image_01">
                        <a href='' id="accessories_link">
                            <img src="../../Image/Glasses/5-17_Product-17_360x.jpg" id="accessories_imgs">
                            <center>
                                <p id="accessories_item1"><b>Thick Sunglasses in Silver/Grey</b></p>
                                <p id="accessories_desc1">Dries Van Noten x Linda Farrow</p>
                                <p id="accessories_desc1">$345.00</p>
                            </center>
                        </a>
                    </div>
                    <div id="Mbk_Accessories_image_02">
                        <a href='' id="accessories_link">
                            <img src="../../Image/Glasses/5-17_Product-1_360x.jpg" id="accessories_imgs">
                            <center>
                                <p id="accessories_item1"><b>Thin Sunglasses in Black/Grey</b></p>
                                <p id="accessories_desc1">Dries Van Noten x Linda Farrow</p>
                                <p id="accessories_desc1">$345.00</p>
                            </center>
                        </a>
                    ...
                    <div id="Mbk_Accessories_image_03">
                        <a href='' id="accessories_link">
                            <img src="../../Image/Glasses/5-17_Product-5_360x.jpg" id="accessories_imgs">
                            <center>
                                <p id="accessories_item1"><b>Sunglasses in Pink/T-Shell/Silver</b></p>
                                <p id="accessories_desc1">Dries Van Noten x Linda Farrow</p>
                                <p id="accessories_desc1">$345.00</p>
                            </center>
                        </a>
                    ...
                    <div id="Mbk_Accessories_image_04">
                        <a href='' id="accessories_link">
                            <img src="../../Image/Glasses/6-2_sunglasses-9_360x.jpg" id="accessories_imgs">
                            <center>
                                <p id="accessories_item1"><b>Thin Sunglasses in Black/Silver</b></p>
                                <p id="accessories_desc1">Dries Van Noten x Linda Farrow</p>
                                <p id="accessories_desc1">$345.00</p>
                            </center>
                        </a>
