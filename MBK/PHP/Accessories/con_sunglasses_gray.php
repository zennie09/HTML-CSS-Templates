    ...
    <body>
        ...
        <div class="Mbk_Accessories_1">
            <div id="Mbk_Accessories_nav">
                <a href="../Mbk_Main.php">Home</a> > <a href="../Mbk_Accessories.php">Accessories</a> > Concorde Sunglasses in Grey
            </div>
            ...
            <div class="container">
                <div id="Mbk_Accessories_image">
                    <img src="../../Image/Glasses/Glasses Angle/Concorde Sunglasses in Grey/5-17_Product-14_8bdb0107-7bab-4798-ac02-2da85ea0c82c_1024x1024@2x.jpg" class="image normal-zoom" id="main">
                </div> 
            </div>
               <div class="box1">
                    <div id="Mbk_Accessories_image1">
                        <img src="../../Image/Glasses/Glasses Angle/Concorde Sunglasses in Grey/5-17_Product-14_8bdb0107-7bab-4798-ac02-2da85ea0c82c_1024x1024@2x.jpg" id="accessories_img" onclick="change(this.src)">
                    </div>
                    <div id="Mbk_Accessories_image2">
                        <img src="../../Image/Glasses/Glasses Angle/Concorde Sunglasses in Grey/5-17_Product-15_753e77a9-fefa-4bd8-be58-66aa5d9714a8_1024x1024@2x.jpg" id="accessories_img" onclick="change(this.src)">
                    </div>
                    <div id="Mbk_Accessories_image3">
                        <img src="../../Image/Glasses/Glasses Angle/Concorde Sunglasses in Grey/5-17_Product-16_72eb6de6-cae1-42c3-9955-5bcf4f4f2051_1024x1024@2x.jpg" id="accessories_img" onclick="change(this.src)">
                    </div>
                    <div id="Mbk_Accessories_image4">
                        <img src="../../Image/Glasses/Glasses Angle/Concorde Sunglasses in Grey/6-2_Womens_SunglassesOnFigure-3_1024x1024@2x.jpg" id="accessories_img" onclick="change(this.src)">
                    </div>
               </div>   
            ...
            <div id="Mbk_Accessories_image_desc_info">
                ...
                <div id="desc_info_links_desc">
                    ...
                    <div id="desc_info_links_desc_1">
                        Madeline Sunglasses in White Gold by Ahlem. 
                        Classic and sleek sunglasses feature a brushed white gold frame, 
                        flat grey lenses, ceramic nose pads, and flex hinges. 
                    </div>
