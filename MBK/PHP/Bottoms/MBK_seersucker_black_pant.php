    ...
    <body>
        ...
        <div class="Mbk_Accessories_1">
            <div id="Mbk_Accessories_nav">
                <a href="../Mbk_Main.php">Home</a> > <a href="../Mbk_Bottom.php">Man Bottom</a> > Seersucker Pant in Black
            </div>
            ...
            <div class="container">
                <div id="Mbk_Accessories_image">
                    <img src="../../Image/Bottoms/Bottoms Angles/Seersucker Pant in Black/02-15_Mens_WIP_215_1024x1024@2x.jpg" class="image normal-zoom" id="main">
                </div> 
            </div>
               <div class="box1">
                    <div id="Mbk_Accessories_image1">
                        <img src="../../Image/Bottoms/Bottoms Angles/Seersucker Pant in Black/02-15_Mens_WIP_215_1024x1024@2x.jpg" id="accessories_img" onclick="change(this.src)">
                    </div>
                    <div id="Mbk_Accessories_image2">
                        <img src="../../Image/Bottoms/Bottoms Angles/Seersucker Pant in Black/02-15_Mens_WIP_203_1024x1024@2x.jpg" id="accessories_img" onclick="change(this.src)">
                    </div>
                    <div id="Mbk_Accessories_image3">
                        <img src="../../Image/Bottoms/Bottoms Angles/Seersucker Pant in Black/02-15_Mens_WIP_219_1024x1024@2x.jpg" id="accessories_img" onclick="change(this.src)">
                    </div>
                    <div id="Mbk_Accessories_image4">
                        <img src="../../Image/Bottoms/Bottoms Angles/Seersucker Pant in Black/02-15_Mens_WIP_221_1024x1024@2x.jpg" id="accessories_img" onclick="change(this.src)">
                    </div>
               </div>   
            ...
            <div id="Mbk_Accessories_image_desc_info">
                ...
                <div id="desc_info_links_desc">
                    ...
                    Seersucker Pant in Black by Smock. Straight-wide, deep-black pant features rounded, drop-crotch and zipper-button closure. 
                    Other features include rounded pockets at sides and clean hem at bottom.
                    </div>

                    <ul id="desc_info_links_ul">
                        <li>100% Cotton</li>
                        <li>Made in Japan</li>
                        <li>Model is 5' 11" and wears a 1</li>
                        <li>16" waist, 38" length</li>
                    </ul>  
                </div>
