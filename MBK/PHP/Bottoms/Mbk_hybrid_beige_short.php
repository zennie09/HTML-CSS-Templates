    ...
    <body>
        ...
        <div class="Mbk_Accessories_1">
            <div id="Mbk_Accessories_nav">
                <a href="../Mbk_Main.php">Home</a> > <a href="../Mbk_Bottom.php">Man Bottom</a> > Hybrid Wading Shorts in Beige
            </div>
            ...
            <div class="container">
                <div id="Mbk_Accessories_image">
                    <img src="../../Image/Bottoms/Bottoms Angles/Beige Hybrid Short/02-15_Mens_WIP_379_1024x1024@2x.jpg" class="image normal-zoom" id="main">
                </div> 
            </div>
               <div class="box1">
                    <div id="Mbk_Accessories_image1">
                        <img src="../../Image/Bottoms/Bottoms Angles/Beige Hybrid Short/02-15_Mens_WIP_379_1024x1024@2x.jpg" id="accessories_img" onclick="change(this.src)">
                    </div>
                    <div id="Mbk_Accessories_image2">
                        <img src="../../Image/Bottoms/Bottoms Angles/Beige Hybrid Short/02-15_Mens_WIP_375_1024x1024@2x.jpg" id="accessories_img" onclick="change(this.src)">
                    </div>
                    <div id="Mbk_Accessories_image3">
                        <img src="../../Image/Bottoms/Bottoms Angles/Beige Hybrid Short/02-15_Mens_WIP_381_1024x1024@2x.jpg" id="accessories_img" onclick="change(this.src)">
                    </div>
                    <div id="Mbk_Accessories_image4">
                        <img src="../../Image/Bottoms/Bottoms Angles/Beige Hybrid Short/02-15_Mens_WIP_387_1024x1024@2x.jpg" id="accessories_img" onclick="change(this.src)">
                    </div>
               </div>   
            ...
            <div id="Mbk_Accessories_image_desc_info">
                ...
                <div id="desc_info_links_desc">
                    ...
                    <div id="desc_info_links_desc_1">
                        Hybrid Wading Shorts in Beige by SMOCK. 
                        Lightweight and breathable shorts are the perfect item for summer, 
                        features include two horizontal side slit pockets at waist, one back pocket, 
                        an elasticized waist with drawstring finish and side vents at short hem.
                    </div>

                    <ul id="desc_info_links_ul">
                        <li>65% cotton, 35% nylon designed in Los angeles.</li>
                        <li>Made in Japan</li>
                        <li>Machine wash warm, gentle cycle, professionally dry clean</li>
                        <li>Model is 6'2" and wears a size 2</li>
                        <li>15" waist, 11" rise, 17.5" length</li>
                    </ul>  
                </div>
