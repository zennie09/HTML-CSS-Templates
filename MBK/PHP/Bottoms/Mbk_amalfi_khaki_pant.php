    ...
    <body>
        ...
        <div class="Mbk_Accessories_1">
            <div id="Mbk_Accessories_nav">
                <a href="../Mbk_Main.php">Home</a> > <a href="../Mbk_Bottom.php">Man Bottom</a> > Amalfi Pant in Khaki
            </div>
            ...
            <div class="container">
                <div id="Mbk_Accessories_image">
                    <img src="../../Image/Bottoms/Bottoms Angles/Amalfi Khaki Pant/06-08_Mens-282_1024x1024@2x.jpg" class="image normal-zoom" id="main">
                </div> 
            </div>
               <div class="box1">
                    <div id="Mbk_Accessories_image1">
                        <img src="../../Image/Bottoms/Bottoms Angles/Amalfi Khaki Pant/06-08_Mens-282_1024x1024@2x.jpg" id="accessories_img" onclick="change(this.src)">
                    </div>
                    <div id="Mbk_Accessories_image2">
                        <img src="../../Image/Bottoms/Bottoms Angles/Amalfi Khaki Pant/06-08_Mens-280_1024x1024@2x.jpg" id="accessories_img" onclick="change(this.src)">
                    </div>
                    <div id="Mbk_Accessories_image3">
                        <img src="../../Image/Bottoms/Bottoms Angles/Amalfi Khaki Pant/06-08_Mens-284_1024x1024@2x.jpg" id="accessories_img" onclick="change(this.src)">
                    </div>
                    <div id="Mbk_Accessories_image4">
                        <img src="../../Image/Bottoms/Bottoms Angles/Amalfi Khaki Pant/06-08_Mens-286_1024x1024@2x.jpg" id="accessories_img" onclick="change(this.src)">
                    </div>
               </div>   
            ...
            <div id="Mbk_Accessories_image_desc_info">
                ...
                <div id="desc_info_links_desc">
                    ...
                    <div id="desc_info_links_desc_1">
                        Amalfi Pant in Khaki by SMOCK. 
                        A beautiful and textured relaxed fitting pant in a breathable cotton and linen blend; 
                        details include two curved pockets at waist, an elasticized waistline with drawstrings at front, 
                        a silver zipper at fly with a button to finish, a slightly tapered leg and two back welt pockets 
                        one with button closure and one without.
                    </div>

                    <ul id="desc_info_links_ul">
                        <li>75% cotton, 25% linen</li>
                        <li>Machine wash wash warm gentle cycle or dry clean; line dry in shade</li>
                        <li>Designed in Los Angeles</li>
                        <li>Made in Japan</li>
                        <li>Model is 6'2" and wears a size M</li>
                        <li>15.5" waist, 14" rise, 41" length, 29" inseam</li>
                    </ul>  
                </div>
